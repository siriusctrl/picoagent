...
mod tests {
    ...
    fn every_local_manifest_parses_and_has_a_unique_name() {
        let definitions = [
            ...
            include_str!("task/close/tool.yaml"),
            include_str!("task/inspect/tool.yaml"),
            include_str!("task/list/tool.yaml"),
            include_str!("task/send/tool.yaml"),
            include_str!("task/status/tool.yaml"),
            include_str!("task/stop/tool.yaml"),
            include_str!("task/wait/tool.yaml"),
