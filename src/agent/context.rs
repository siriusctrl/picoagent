...
use crate::{memory::MemoryPaths, prompts::agent_prompts};

pub fn build_system_prompt() -> String {
    agent_prompts().system.clone()
}
...
mod tests {
    ...
    fn keeps_dynamic_context_out_of_the_system_prompt() {
        ...
        assert!(system.contains("For a large independent consolidation"));
        assert!(system.contains("Use `write` or `bash` for a small focused update"));
    }
}
